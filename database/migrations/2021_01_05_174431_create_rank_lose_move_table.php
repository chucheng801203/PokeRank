...
class CreateRankLoseMoveTable extends Migration
{
    protected $tableName = 'rank_lose_move';
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up()
    {
        ...
        DB::statement("ALTER TABLE `$tableName` comment 'pokemon 每個賽季被打倒時對手所使用的招式百分比'");
    }
