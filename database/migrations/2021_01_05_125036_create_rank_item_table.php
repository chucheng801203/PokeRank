...
class CreateRankItemTable extends Migration
{
    protected $tableName = 'rank_item';
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up()
    {
        ...
        Schema::create($tableName, function (Blueprint $table) {
            ...
            $table->unsignedSmallInteger('item_id')->nullable(true)->comment('道具 id');
            ...
            $table->foreign('item_id')->references('id')->on('item')->onUpdate('cascade')->onDelete('SET NULL');
        ...
        DB::statement("ALTER TABLE `$tableName` comment 'pokemon 每個賽季所使用的道具百分比'");
    }
